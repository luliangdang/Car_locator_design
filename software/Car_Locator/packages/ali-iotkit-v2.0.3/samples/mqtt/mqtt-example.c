...
//    rand_num_b = (uint8_t)(rand()%255);
    ...
    snprintf(msg_pub, sizeof(msg_pub), 
            "{\"id\" : \"%d\",\"iotId\":\"L1k0RZwxCrDfLuU6ImFQ000100\","
            "\"version\":\"1.0\",\"params\" : "
            "{\"GeoLocation\" : {\"CoordinateSystem\":1,"
            "\"Latitude\":%.4f,"
            "\"Longitude\":%.4f,"
            "\"Altitude\":%.1f}},"
            "\"method\":\"thing.event.property.post\","
            "\"uniMsgId\":\"4788176938936356864\","
            "\"topic\":\"/sys/a1HSScmFON5/Car_Locator/thing/event/property/post\"}",
            ++pub_msg_cnt, (float)gps_data.latitude / 100000.0, (float)gps_data.longitude / 100000.0, (float)gps_data.altitude / 10.0);
		
//		snprintf(msg_pub, sizeof(msg_pub),
//						"{\"id\":\"%d\","
//						"\"iotId\":\"L1k0RZwxCrDfLuU6ImFQ000100\","
//						"\"method\":\"thing.event.property.post\","
//						"\"params\":"
//						"{\"GeoLocation\":{\"CoordinateSystem\":1,\"Latitude\":%.4f,\"Longitude\":%.4f,\"Altitude\":112.5}},"
//						"\"topic\":\"/sys/a1HSScmFON5/Car_Locator/thing/event/property/post\","
//						"\"uniMsgId\":\"4788129472148983808\",\"version\":\"1.0\"}",
//						++pub_msg_cnt,
//						(float)gps_data.latitude / 100000.0,
//						(float)gps_data.longitude / 100000.0);
