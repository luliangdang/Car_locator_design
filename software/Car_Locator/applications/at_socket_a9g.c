...
static void urc_recv_func(const char *data, rt_size_t size)
{
    ...
    sscanf(data, "+CIPRCV,%d,%d:", &socket, (int *) &bfsz);
...
#define CREG_RETRY                     10
    ...
    while (1)
    {
        ...
        AT_SEND_CMD(resp, 1, 300, "AT+CIPMUX?");
...
MSH_CMD_EXPORT(a9g_client_init, client test);
